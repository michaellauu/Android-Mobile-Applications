...
public class AddVoice extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    public class JavaScriptInterface {
        ...
        public void record() {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    /*Method code here*/
                    Toast.makeText(AddVoice.this, "Recording",
        ...
        public void stop() {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    /*Method code here*/
                    Toast.makeText(AddVoice.this, "Stopping",
                            Toast.LENGTH_LONG).show();
        ...
        public void play() {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    /*Method code here*/
                    Toast.makeText(AddVoice.this, "Playing",
                            Toast.LENGTH_LONG).show();
        ...
        public void stoprec() {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    /*Method code here*/
                    Toast.makeText(AddVoice.this, "Stopping recording",
                            Toast.LENGTH_LONG).show();
                    if (mediaPlayer != null) {
                        mediaPlayer.stop();
                        mediaPlayer.release();
        ...
        public void exit(){
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    /*Method code here*/
                    Intent i = new Intent(AddVoice.this, MainActivity.class);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(AddVoice.this, new
            ...
            case RequestPermissionCode:
                if (grantResults.length> 0) {
                    ...
                    if (StoragePermission && RecordPermission) {
                        Toast.makeText(AddVoice.this, "Permission Granted",
                                Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(AddVoice.this,"Permission Denied",Toast.LENGTH_LONG).show();
                    }
                }
                break;
        }
